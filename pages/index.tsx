...
const aboutSummary = [
  'Практикующий системный администратор с опытом работы в производстве и финансовом секторе. Развивается в сторону DevOps и использует Docker, Ansible, Git, Grafana и SQL для автоматизации рутинных задач и сопровождения инфраструктуры.',
  'Имеет реальный опыт администрирования Linux и Windows, работы с Proxmox, сетями, VPN, мониторингом и анализом логов. Ищет проект, где сможет углублять компетенции в виртуализации, мониторинге и облачных технологиях.',
]
